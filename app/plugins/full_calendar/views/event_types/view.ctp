...
<div class="related">
	<?php /* <h3><?php __('Related Events');?></h3> */ ?>
	<?php if (!empty($eventType['Event'])):?>
	<table cellpadding = "0" cellspacing = "0">
	<tr>
		<th><?php __('Title'); ?></th>
		<?php /*<th><?php __('Status'); ?></th>*/?>
		<th><?php __('Start'); ?></th>
        <th><?php __('End'); ?></th>
        <?php /* <th><?php __('All Day'); ?></th> */ ?>
	...
	<?php
		...
		<tr<?php echo $class;?>>
			...
			<?php /*<td><?php echo $event['status'];?></td>*/?>
			<td><?php echo $event['start'];?></td>
            <td><?php if($event['all_day'] != 1) { echo $event['end']; } else { echo "N/A"; } ?></td>
            <?php /*<td><?php if($event['all_day'] == 1) { echo "Yes"; } else { echo "No"; }?></td>*/?>
